...
$\textsf{\color{green}Дополнительные сведения по серии из}$  [Factory Config](./bootloader/README.md)
...
#### $\textsf{\color{green}Проверка что это один и тот-же кристалл}$
...
#### $\textsf{\color{green}Прошивка с ошибкой - как тест сброса контроллера}$
...
#### $\textsf{\color{green}Стирание прошивки (сброс) при использовании служебных выводов (SWC,SWD,NRST)}$
