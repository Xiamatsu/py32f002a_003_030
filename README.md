$\LARGE\textbf{\color{blue}Обзор и тестирование семейства контроллеров PY32F002A,F003,F030}$<br>

$\Large\textbf{\color{orange}Введение}$<br>
...
Обновляется довольно часто, но только SDK и программы.<br>
