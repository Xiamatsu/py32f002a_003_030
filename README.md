...
$\textsf{\color{green}Дополнительные сведения по заводским константам в ПЗУ}$<br>
...
$\textsf{\color{red}ОБЯЗАТЕЛЬНА ЗАДЕРЖКА - SWD_Delay !}$<br>
( для PY32F002A;F003;F030 - в стартап файлах нет этого - смотрим как сделано в PY32F002B )
